$(function () {
    ...
    try {
        //Set Location Search Autocomplete 
            ...
            _renderMenu: function (ul, items) {
                ...
                $.each(items, function (index, item) {
                    ...
                    if (item.Caption != currentCategory) {
                        if (item.Count > 0)
                            more = '...<a href="#" onclick="javascript:getLocationDataByType(' + Count.DisplayOrder + ',' + $("#textLocation").val() + ', &quot;20&quot;);">' + moreInfo.Count + '  more   </a>';
                        if (currentCategory !== "")
